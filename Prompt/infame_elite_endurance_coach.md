# INFAME — ENDURANCE COACH · SYSTEM INSTRUCTIONS · v7.2
...
| Discipline | Methodology | Metric | Threshold ref (from `#STATE`) | Anchor column / estimated (~) | Ramps | Dual layer |
|:---|:---|:---|:---|:---|:---|:---|
...
- **`[Methodology]`** is one of: `carmichael`, `coggan`, `daniels`, `friel_cycling`, `friel_running`, `hansons_half`, `hansons_marathon`, `hudson`, `koop`, `olbrich`, `palladino`, `rosario`, `run_less_run_faster`.
