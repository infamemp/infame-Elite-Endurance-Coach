...
- **`[Methodology]`** is one of: `carmichael`, `coggan`, `daniels`, `friel_cycling`, `friel_running`, `hansons_half`, `hansons_marathon`, `koop`, `olbrich`, `palladino`, `rosario`, `run_less_run_faster`.
