...
* **Available Metrics:** % CTS Field Test, % LTHR
* **Primary Metrics:** CTS Field Test Power, CTS Field Test Heart Rate (LTHR)
* **Intensity Anchors:** % CTS Field Test, % LTHR
* **LTHR Status:** Native
...
* **% FTP (equivalent):** generated by multiplying the author's percentages by 1.1. Use this column for an athlete who has a threshold value but has not performed the author's own test. Source: The Time-Crunched Cyclist, 3rd ed. 2017, Ch. 4 — "CTS Field Test avg power is approximately 10% above lab-tested LT power. This 10% is already factored into the Table 4.1 percentages."
* **Class assigned from:** the equivalent column — classification cutpoints are calibrated on threshold, so TSS stays comparable with the other methodologies.

| Zone Key | Zone Name | % CTS Field Test Range | % FTP (equivalent) | % LTHR Range | RPE (1-10) | Class | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| EM | EnduranceMiles | 45–73% | 50–80% | 50–91% | 5 | Endurance |  |
| T | Tempo | 80–85% | 88–94% | 88–90% | 6 | Sub-threshold |  |
| SS | SteadyState | 86–90% | 95–99% | 92–94% | 7 | Threshold |  |
| CR | ClimbingRepeat | 95–100% | 105–110% | 95–97% | 8 | VO2max |  |
| OU | OverUnder | N/A | N/A | N/A | 9 | Threshold | Alternating Under and Over. Under = SS, Over = CR. Native scale 86-90 and 95-100 % CTS Field Test; FTP equivalent 95-99 and 105-110 %. Heart rate 92-94 and 95-97 % LTHR. |
| PI | PowerInterval | > 101% | > 111% | > 100% | 10 | VO2max | Max effort; no defined upper bound |
